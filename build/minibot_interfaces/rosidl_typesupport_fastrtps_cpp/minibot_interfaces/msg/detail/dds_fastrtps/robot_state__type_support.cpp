...
#include "minibot_interfaces/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = minibot_interfaces::msg::RobotState;
    is_plain =
      (
      offsetof(DataType, right_lamp) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const minibot_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<minibot_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
get_message_type_support_handle<minibot_interfaces::msg::RobotState>()
{
  return &minibot_interfaces::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
